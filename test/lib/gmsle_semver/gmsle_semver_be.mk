...
# Test the variable
test_in1 := $(shell echo '	01	')
test_in2 := $(shell echo '	>=	')
test_in3 := $(shell echo '	2	')
test_exp :=
...
# Test the variable
test_in1 := $(shell echo '	02	')
test_in2 := $(shell echo '	>=	')
test_in3 := $(shell echo '	2.2	')
test_exp :=
test_out := $(call $(test_name)_$(test_type),$(test_in1),$(test_in2),$(test_in3))
