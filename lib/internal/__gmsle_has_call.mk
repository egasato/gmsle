...
ifndef __gmsle_has_call
    ...
    ifneq '$(__gmsle_semver_be_3_77_90)' ''
        ...
        __gmsle_has_call = $(1)
        __gmsle_has_call := $(call __gmsle_has_call,$(gmsle_true))
        ifeq '$(__gmsle_has_call)' '$(gmsle_true)'
            __gmsle_has_call = $(gmsle_true)
        else
            ifeq '$(GMSLE_INCLUDE)' '$(GMSLE_INCLUDE_AUTOMATIC)'
                $(call __gmsle_include_ifndef,gmsle_false,$(LIB_GMSLE_PATH)/lib/gmsle_false/GNUmakefile)
            endif
            __gmsle_has_call = $(gmsle_false)
        endif
    else
        ifeq '$(GMSLE_INCLUDE)' '$(GMSLE_INCLUDE_AUTOMATIC)'
            $(call __gmsle_include_ifndef,gmsle_false,$(LIB_GMSLE_PATH)/lib/gmsle_false/GNUmakefile)
