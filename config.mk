...
GMSLE_ASCIIDOCTOR      ?= asciidoctor
GMSLE_ASCIIDOCTORFLAGS ?=
GMSLE_ASCIIDOC         ?= asciidoc
GMSLE_ASCIIDOCFLAGS    ?=
GMSLE_AWK              ?= awk
GMSLE_CMP              ?= cmp
...
GMSLE_TARGET_ADOC2HTML_PREFER    ?=
GMSLE_TARGET_ADOC2HTML_INCLUDE   ?= $(GMSLE_INCLUDE_AUTOMATIC)
GMSLE_TARGET_ADOC2HTML_AUTOCLEAN ?= \\#t

GMSLE_TARGET_CLEAN_PREFER   ?=
GMSLE_TARGET_CLEAN_INCLUDE  ?= $(GMSLE_INCLUDE_AUTOMATIC)
GMSLE_TARGET_CLEAN_UPTODATE ?=

GMSLE_TARGET_GO_BUILD_PREFER    ?=
GMSLE_TARGET_GO_BUILD_INCLUDE   ?= $(GMSLE_INCLUDE_AUTOMATIC)
GMSLE_TARGET_GO_BUILD_AUTOCLEAN ?= \\#t

GMSLE_TARGET_LN_PREFER    ?=
GMSLE_TARGET_LN_INCLUDE   ?= $(GMSLE_INCLUDE_AUTOMATIC)
GMSLE_TARGET_LN_AUTOCLEAN ?= \\#t
GMSLE_TARGET_LN_ECHO      ?= \\#t
GMSLE_TARGET_LN_UPTODATE  ?= \\#t
GMSLE_TARGET_LN_OVERRIDE  ?= \\#t

GMSLE_TARGET_ODT2PDF_PREFER    ?=
GMSLE_TARGET_ODT2PDF_INCLUDE   ?= $(GMSLE_INCLUDE_AUTOMATIC)
GMSLE_TARGET_ODT2PDF_AUTOCLEAN ?= \\#t

GMSLE_TARGET_TOUCH_PREFER    ?=
GMSLE_TARGET_TOUCH_INCLUDE   ?= $(GMSLE_INCLUDE_AUTOMATIC)
GMSLE_TARGET_TOUCH_AUTOCLEAN ?= \\#t
